...
module.exports = {
  siteMetadata: {
    title: `Nguyen Thai Hoa - Lead Front-end Engineer`,
    author: {
      name: `Nguyen Thai Hoa`,
      summary: `My name is Hoa, and I have extensive engineering experience in the software industry. I have a T-shaped knowledge across various fields, and my primary expertise is in front-end development, with a focus on React Js and React Native. I also possess secondary expertise in back-end development (NodeJs and GraphQL) and Cloud (AWS). In April 2023, I obtained AWS Cloud Practitioner certification, which is valid until 2026.`,
    },
    description: `A starter blog demonstrating what Gatsby can do.`,
    siteUrl: `Nguyen Thai Hoa - Lead Front-end Engineer`,
    social: {
      twitter: `kylemathews`,
    },
    siteUrl: 'https://www.linkedin.com/in/hoa-thai-nguyen-22949611b/'
  },
  plugins: [
    `gatsby-plugin-image`,
    {
